...
# class ThreadReport(db.Model):
#     __tablename__ = 'thread_report'
#     id = db.Column(db.Integer, primary_key=True)
#     thread_id = db.Column(db.Integer, db.ForeignKey('thread.id'), nullable=False)
#     reporter_id = db.Column(db.String(100), db.ForeignKey('front_user.id'), nullable=True)
#     reporter_ip = db.Column(db.String(15), nullable=True)
#     create_time = db.Column(db.DateTime, default=datetime.now)
